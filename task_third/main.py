...
path_to_text_1 = Path('task_third/text_1.txt')
path_to_text_2 = Path('task_third/text_2.txt')
# Пошук Боєра
...
pattern_exist = "computer"
pattern_fake = "qwertyqwerty"
repeats = 4

with open(path_to_text_1, 'r', encoding='utf-8') as file:
    text_1 = file.read()

with open(path_to_text_2, 'r', encoding='utf-8') as file:
    text_2 = file.read()
...
texts = [("Article 1", text_1), ("Article 2", text_2)]

patterns = [
    ("exists", pattern_exist),
    ("fake", pattern_fake)
]
...
for text_name, text in texts:
    ...
    for pattern_name, pattern in patterns:
        ...
        for algo_name, algo in algorithms:
            elapsed = timeit.timeit(lambda: algo(text,pattern), number=3)
            print(algo_name, elapsed)
